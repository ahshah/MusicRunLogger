...
#TOOLSPATH = /Volumes/FatherTime/Arduino.app/Contents/Java/hardware/tools
...
#COMPILERPATH = /Volumes/FatherTime/Arduino.app/Contents/Java/hardware/tools/arm/bin
...
CPPFLAGS = -Wall -g -O2 -mthumb -ffunction-sections -fdata-sections -nostdlib -MMD $(OPTIONS) -DTEENSYDUINO=142 -DARDUINO=10805 -DF_CPU=$(TEENSY_CORE_SPEED) -Isrc -I$(COREPATH)

# compiler options for C++ only
#CXXFLAGS = -std=gnu++0x -felide-constructors -fno-exceptions -fno-rtti
CXXFLAGS = -std=gnu++14 -felide-constructors -fno-exceptions -fno-rtti -fsingle-precision-constant

# compiler options for C only
CFLAGS =

# linker options
LDFLAGS = -O2 -Wl,--gc-sections,--defsym=__rtc_localtime=$(shell date +"%s") -mthumb
ASFLAGS =
...
ifeq ($(TEENSY), 30)
    ...
    LDFLAGS += -mcpu=cortex-m4 -T$(LDSCRIPT)
    ASFLAGS += -g -mcpu=cortex-m4 -mthumb  -mfpu=vfp 
else ifeq ($(TEENSY), LC)
...
L_INC_SRC := $(foreach lib,$(filter %/, $(wildcard $(LIBRARYPATH)/*/src/)), -I$(lib))
L_INC := $(L_INC) $(L_INC_SRC)
# LIBS +=  libSFE_MicroOLED.a core.a
LIBS +=  /Users/ali/ws/teensy/cores-1.41/teensy3/core.a

SOURCES := $(C_FILES:.c=.o) $(CPP_FILES:.cpp=.o) $(INO_FILES:.ino=.o) $(TC_FILES:.c=.o) $(TCPP_FILES:.cpp=.o) $(LC_FILES:.c=.o) $(LCPP_FILES:.cpp=.o) $(LASM_FILES:.S=.o)
...
load: all
	sleep 0.2
	~/Downloads/teensy_loader_cli -w -mmcu=mk20dx256 "$(TARGET).hex"
